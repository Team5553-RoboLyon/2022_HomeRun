...
// #define NMAKEWORD(lo,hi)( (Nu16) (( ((Nu16)((Nu8)(lo))) & 0xFF ) | ( ( ((Nu16)((Nu8)(hi))) & 0xFF ) << 8 )) )

// Versions without bits masks...
// ..........................................................
#define NLOWORD(l) ((l)&0xFFFF)
#define NHIWORD(l) (((l)&0xFFFF0000) >> 16)
#define NMAKELONG(lo, hi) (((lo)&0xFFFF) | (((hi)&0xFFFF) << 16))

#define NLOBYTE(w) ((w)&0xFF)
#define NHIBYTE(w) (((w)&0xFF00) >> 8)
#define NMAKEWORD(lo, hi) (((lo)&0xFF) | (((hi)&0xFF) << 8))

#define NLONIBBLE(b) ((b)&0xF)
#define NHINIBBLE(b) (((b)&0xF0) >> 4)
#define NMAKEBYTE(lonibble, hinibble) (((lonibble)&0xF) | (((hinibble)&0xF) << 4))
